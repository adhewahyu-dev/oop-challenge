...
class Cart {
	...
	totalItems() { 
        console.log('Total Items : '+this.array.length)
    }
	totalQuantity() {
		let total = 0;
		this.array.forEach(function(e) { total += e.quantity; });
		console.log('Total Quantitiy : '+total);
	}
	totalPrice() {
		let total = 0;
...
const cart = new Cart()
const a = cart.addItem({ item_id: 1, price: 30000, quantity: 3 })
